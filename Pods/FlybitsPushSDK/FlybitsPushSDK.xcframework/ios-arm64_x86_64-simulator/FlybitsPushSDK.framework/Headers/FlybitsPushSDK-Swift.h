...
/// A class that holds information of a push notification
...
/// note:
/// The code value must follow the <code>ISO 639</code> specifications.
/// note:
...
/// note:
/// The [codes] must follow the <code>ISO 639</code> specifications.
/// \param codes List of language code. <em>Order does matter.</em>
///
...
/// Universal Action Push that SDK will perform different action depends on actionScheme
SWIFT_CLASS("_TtC14FlybitsPushSDK19UniversalActionPush")
@interface UniversalActionPush : Push
@end
