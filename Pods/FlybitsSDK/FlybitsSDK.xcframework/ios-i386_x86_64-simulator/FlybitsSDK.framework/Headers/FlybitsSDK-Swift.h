...
/// \param projectId The project to associate with
///
/// \param physicalDeviceId The custom physical device id to connect to flybits
///
/// \param error Contains failed authentication result
///
///
/// returns:
/// A cancellable <code>FlybitsRequest</code> object.
+ (FlybitsRequest * _Nonnull)connectWithIDP:(id <IDP> _Nonnull)idp customerId:(NSString * _Nullable)customerId projectId:(NSString * _Nullable)projectId physicalDeviceId:(NSString * _Nullable)physicalDeviceId completion:(void (^ _Nonnull)(User * _Nullable, NSError * _Nullable))completion;
